...
[settlement.domain]
chain_id = $origin_id
address = "${INPUT_SETTLER_ADDRESS:-0x0000000000000000000000000000000000000000}"
...
input = { $origin_id = ["${ORACLE_ADDRESS:-0x0}"], $dest_id = ["${ORACLE_ADDRESS:-0x0}"] }
output = { $origin_id = ["${ORACLE_ADDRESS:-0x0}"], $dest_id = ["${ORACLE_ADDRESS:-0x0}"] }
...
[networks.$origin_id]
input_settler_address = "${INPUT_SETTLER_ADDRESS:-0x0000000000000000000000000000000000000000}"
...
output_settler_address = "${OUTPUT_SETTLER_ADDRESS:-0x0000000000000000000000000000000000000000}"
...
show_summary() {
    ...
    if [ "$DEPLOY_CONTRACTS" = true ] && [ "$DRY_RUN" = false ]; then
        ...
        echo "  Oracle:        ${ORACLE_ADDRESS:-Not deployed}"
        echo "  InputSettler:  ${INPUT_SETTLER_ADDRESS:-Not deployed}"
        echo "  OutputSettler: ${OUTPUT_SETTLER_ADDRESS:-Not deployed}"
        echo
    fi
