...
mod tests {
    ...
    fn test_parse_amount() {
        // Test basic parsing
        assert_eq!(parse_amount("1.0").unwrap(), U256::from(1_000_000_000_000_000_000u128));
        assert_eq!(parse_amount("0.1").unwrap(), U256::from(100_000_000_000_000_000u128));
        assert_eq!(parse_amount("100").unwrap(), U256::from(100_000_000_000_000_000_000u128));
        
        // Test with different decimals
        assert_eq!(parse_amount_with_decimals("1.0", 6).unwrap(), U256::from(1_000_000u128));
        assert_eq!(parse_amount_with_decimals("100", 6).unwrap(), U256::from(100_000_000u128));
    ...
    fn test_format_amount() {
        ...
        assert_eq!(format_amount(U256::from(1_000_000_000_000_000_000u128)), "1.0");
        assert_eq!(format_amount(U256::from(100_000_000_000_000_000u128)), "0.1");
        assert_eq!(format_amount(U256::from(1_500_000_000_000_000_000u128)), "1.5");
        assert_eq!(format_amount(U256::ZERO), "0.0");
        
        // Test with different decimals
        assert_eq!(format_amount_with_decimals(U256::from(1_000_000u128), 6), "1.0");
        assert_eq!(format_amount_with_decimals(U256::from(1_500_000u128), 6), "1.5");
    }
